  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Agendamiento no médico
        </h1>
        <p 
          className="text-center transition-colors duration-300" 
          style={{ color: 'var(--text-muted)' }}
        >
          Reserva boxes para reuniones, capacitaciones u otros fines
        </p>
      </div>
                  ...
                  {boxesRecomendados.length === 0 ? (
                    ...
                    <>
                      <p 
                        ...
                        style={{ color: 'var(--text-muted)' }}
                      >
                        No hay boxes en el pasillo {pasilloFiltro}
                      </p>
                      <p 
                        className="text-sm mt-1 transition-colors duration-300" 
                        style={{ color: 'var(--text-muted)' }}
                      >
                        Intenta con otro pasillo
                      </p>
                    </>
                  )}
                </div>
            ...
            >
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className={`w-full border rounded-lg px-3 py-2 focus:ring-2 transition-colors duration-300 ${
                    observacionesError ? 'border-red-500 focus:border-red-500' : ''
                  }`}
                  style={{ 
                    borderColor: observacionesError ? '#ef4444' : 'var(--border-color)',
                    backgroundColor: 'var(--bg-color)',
                    color: 'var(--text-color)'
                  }}
                  rows="3"
          ...
          >
            ...
            >
              ...
              <p 
                ...
                style={{ color: 'var(--text-muted)' }}
              >
                ¿Estás seguro de que deseas liberar esta agenda?
              </p>
