...
export default function AgendarMedica() {
  ...
  const realizarReserva = async () => {
    ...
    try {
      ...
      const data = await response.json();
      if (response.ok) {
        setMensaje({ texto: "Reserva médica realizada con éxito", tipo: "success" });
  ...
  return (
    <div className="min-h-screenrelative pb-20 px-4 md:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
          >
            <h2 className="text-xl font-semibold text-[#5FB799] mb-4">Mis reservas médicas</h2>
